...
let respondido = false; // Flag para controlar se a pergunta atual já foi respondida
...
menuBtn.addEventListener("click", () => {
  ...
  document.body.classList.toggle("menu-aberto"); // Adiciona ou remove a classe 'menu-aberto' no body para mostrar/esconder o menu
});
